(function($) {
  ...
  $(function() {
    ...
    if ($("#contrataciones").length) {
      var statusSummaryChartCanvas = document.getElementById("contrataciones").getContext('2d');;
      var statusData = {
          labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
          datasets: [{
              label: '# of Votes',
              data: [100, 1, 110, 10, 100, 400],
    ...
    if ($("#dona-resultado").length) {
      var doughnutChartCanvas = $("#dona-resultado").get(0).getContext("2d");
      var doughnutPieData = {
        datasets: [{
          data: [942, 25, 2452],
          backgroundColor: [
      ...
      var doughnutPieOptions = {
        ...
        legendCallback: function (chart) {
          var text = [];
          var v ='';
          text.push('<div class="chartjs-legend"><ul class="justify-content-between">');
          ...
          for (var i = 0; i < chart.data.datasets[0].data.length; i++) {
            ...
            v = chart.data.datasets[0].data[i];
            text.push('<li ><span style="background-color:white">&nbsp; </span><h4 >'+v+'</h4></li>');
          }
          text.push('</div></ul>');
          return text.join("");
        },
      ...
      document.getElementById('dona-resultado-legend').innerHTML = doughnutChart.generateLegend();
    }
...
function load_plazas_activas(d){
  if ($("#plazas-activas").length) {
      var statusSummaryChartCanvas = document.getElementById("plazas-activas").getContext('2d');;
      var statusData = {
          labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
          datasets: [{
              label: '# of Votes',
...
function load_total_aplicantes(d){
  if ($("#total-de-aplicantes").length) {
      var statusSummaryChartCanvas = document.getElementById("total-de-aplicantes").getContext('2d');;
      var statusData = {
          labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
          datasets: [{
              label: '# of Votes',
