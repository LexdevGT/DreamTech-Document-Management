...
error_log($query);
  ...
  if (!empty($nombre_doc)) {
    ...
    $linkcomplete = $link.$nombre_archivo[0];
      ...
      $query1 = "INSERT INTO documentation (`display_name`, `file_name`, `description`, `size`, `cat1`, `ISBN`, `pages_qty`, `publish_date`, `author`, `file_path`)VALUES('$nomb','$nombre_archivo[0]','$descrp','$tamano_archivo[0]','$cat','$isbn','$pag','$f_publi','$autor','$cat')";
